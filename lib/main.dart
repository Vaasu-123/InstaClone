  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyCaRoENNfGjDxIJ_ARNkUZr0txQuMzPjZA",
        appId: "1:631593092206:web:cb27077ec450a9d29ed27f",
        messagingSenderId: "631593092206",
        projectId: "instagram-clone-fb602",
        storageBucket: "instagram-clone-fb602.appspot.com",
      ),
    );
  } else {
    await Firebase.initializeApp();
